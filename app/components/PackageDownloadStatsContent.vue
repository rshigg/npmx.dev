...
<template>
  <div>
    ...
    <button
      ...
      class="link-subtle font-mono text-sm w-full flex justify-end items-center gap-1.5 shrink-0 mt-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fg/50 rounded"
      :title="$t('package.downloads.analyze')"
    >
      <span class="i-carbon-data-analytics w-4 h-4" aria-hidden="true" />
      <span>{{ $t('package.downloads.analyze') }}</span>
    </button>
